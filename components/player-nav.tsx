      ...
      {NAV.map(({ href, icon, label }) => {
        ...
        return (
          <Link
            key={href}
            href={href}
            className={`tap flex min-w-0 flex-1 flex-col items-center justify-center gap-[3px] rounded-[12px] px-0.5 py-2 lg:flex-none lg:flex-row lg:justify-start lg:gap-[14px] lg:px-[14px] lg:py-3 ${
